...
from mnist_capnet.utils import combine_images
from PIL import Image
from mnist_capnet.capsulelayers import CapsuleLayer, PrimaryCap, Length, Mask
...
def train(model, data, args):
    ...
    from mnist_capnet.utils import plot_log
